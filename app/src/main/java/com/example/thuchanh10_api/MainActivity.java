package com.example.thuchanh10_api;
...
public class MainActivity extends AppCompatActivity {
    ...
    String url = "https://60c07d47b8d36700175550d2.mockapi.io/Student"; 
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bntClick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String urlGet="https://60c07d47b8d36700175550d2.mockapi.io/Student";
                GetData(urlGet);
                //GetJson(url);
                //GetArrayJson(url);
                //PostApi(url);
        ...
        btnDel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String urlDel="https://60c07d47b8d36700175550d2.mockapi.io/Student";
                DeleteApi(urlDel);
            }
        });
        btnPut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String urlPost = "https://60c07d47b8d36700175550d2.mockapi.io/Student";
                PostApi(urlPost);
            }
        });
    ...
    private void PostApi(String url){
                ...
                })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("name", "Toan");
                params.put("username", "KhanhToan");
                params.put("password", "toan");
